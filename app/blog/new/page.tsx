...
const blogSchema = z.object({
    ...
    imageUrl: z.string().min(1, { message: 'Please select an cover image for your blog' }).url({ message: "Invalid image URL" }),
...
export default function CreateBlogForm() {
    ...
    async function onSubmit(values: BlogFormValues) {
        try {
            setLoading(true);
            const req = await axios.post('/api/blog/new', values, {
                headers: {
    ...
    return (
        <div className="bg-gray-200 py-10 w-screen">
                ...
                <div className="lg:col-span-1">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <Button type="submit" className="ms-auto block" size={'lg'}>Publish Blog</Button>
                        </form>
                    </Form>
                </div>
            </div>
